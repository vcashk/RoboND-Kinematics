...
def handle_calculate_IK(req):
    ...
    if len(req.poses) < 1:
        ...
        # Initializing the service response
        joint_trajectory_list = []

        # Defining the DH param symbols (angles,lengths and offsets)
        ...
        # Transforming from the base link to end effector
        ...
        #then rotating around y-axis by -pi/2
        R_y = Matrix([[             cos(-pi/2),         0,                   sin(-pi/2),     0],
           [                        0,                  1,                   0,              0],
           [                        -sin(-pi/2),        0,                   cos(-pi/2),     0],
           [                        0,                  0,                   0,              1]])

        #calculating the total correction factor
